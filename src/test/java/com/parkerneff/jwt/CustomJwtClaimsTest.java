...
public class CustomJwtClaimsTest {
    ...
    public void testGenerateJwt() {
        ...
        Map<String, KeyPair> keyPairMap = keyPairService.getKeyPairs();
        tokenService.setKeyMap(keyPairMap);
        ...
        JwtConsumer jwtConsumer = new JwtConsumerBuilder()
                ...
                .setVerificationKey(keyPairMap.get("k1").getPublic()) // verify the signature with the public key
